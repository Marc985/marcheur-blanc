...
public class MarcheurIT {
    @Test
    void verifierSiLeMarcheurArriveAuDestination(){
        ...
        Marcheur marcheur=new Marcheur("marcheur");
       List<Lieu> trajectoire= marcheur.marcher(hei,ESTI,carte);

       Assertions.assertTrue(trajectoire.contains(pullman));
        Assertions.assertEquals(trajectoire.getLast().getNom(),"esti");
    }
}
